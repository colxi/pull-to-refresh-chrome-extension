...
* @Last Modified time: 2018-10-16 20:11:18
*/
//
// pull-to-refresh
//
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    if (getComputedStyle(document.body).overscrollBehaviorY === 'contain') {
        console.info('Pull to refresh disabled in this website. ( body.styles.overscroll-behavior-y = contain ) ')
        return false;
    }
    ...
    initiateReload = (items) => {
        ...
        document.addEventListener('wheel', gestures.scrollEventHandler, { passive: true });
        document.addEventListener('touchmove', gestures.scrollEventHandler, { passive: true });
    ...
    chrome.storage.local.get('sensitivitySettings', (items) => initiateReload(items));
